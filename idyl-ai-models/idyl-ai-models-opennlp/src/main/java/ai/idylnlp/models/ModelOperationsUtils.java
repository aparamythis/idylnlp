...
public class ModelOperationsUtils {
	...
	public static SubjectOfTrainingOrEvaluation getSubjectOfTrainingOrEvaluation(TrainingDefinitionReader reader) {
		...
		if(reader.getTrainingDefinition().getTrainingdata().getFormat().equalsIgnoreCase("idylnlp")) {			
		...
		} else if(reader.getTrainingDefinition().getTrainingdata().getFormat().equalsIgnoreCase("conll2003")) {
