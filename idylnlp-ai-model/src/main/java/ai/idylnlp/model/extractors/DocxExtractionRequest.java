...
/**
 * A request to extract sentences from a Microsoft Word document (.docx file).
 * @author Mountain Fog, Inc.
 *
 */
public class DocxExtractionRequest extends TextExtractionRequest {
	 ...
	 */
	public DocxExtractionRequest(FileInputStream fileInputStream) {
